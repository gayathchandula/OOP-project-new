...
<form method="post" action="registration.jsp" >
    <center>
        <table  border="2" width="50%" cellpadding="5">
            <thead>
            <tr>
                <th colspan="2" style="color:blue; font-size:30px;"><span style="background-color: #FFFF00">Enter Information Here</span></th><!-- -------------------------- signup form begin -->
            </tr>
            </thead>
            <tbody>
            <tr>
            ...
            <tr>
                <td colspan="2">Already registered!! <a href="Loginuser.jsp">Login Here</a></td><!-- ----------------------------- end of the form -->
            </tr>
            </tbody>
        </table>
    </center>
